...
/** Draw using cached OpenGLES textures. Requires LV_USE_OPENGLES */
    ...
    #ifndef LV_DRAW_OPENGLES_TEXTURE_CACHE_SIZE
        #ifdef CONFIG_LV_DRAW_OPENGLES_TEXTURE_CACHE_SIZE
            #define LV_DRAW_OPENGLES_TEXTURE_CACHE_SIZE CONFIG_LV_DRAW_OPENGLES_TEXTURE_CACHE_SIZE
        #else
